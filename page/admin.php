...
<div class="wrap cmcmg_admin_page">
    ...
    <h1>
		...
		?>		
		<button type="button" id="cmcmg-form-migration-impport-btn" class="page-title-action cmcmg-help-tip" data-tip="Import Projects" onclick="jQuery('form#cmcmg-form-migration-import').slideToggle('fast').find(':file').focus();" >                
	...
	<div>
		...
		<div id="cmcmg_admin_page_body" class="cmcmg_admin_page_<?php echo $sel_page; ?>"> 
			<?php
				cmc_migrate::menu_render( $sel_page, $_REQUEST['section'], $menus );
			?>
		</div>
	</div>
