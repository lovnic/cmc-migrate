...
<div class="cmcmg_section_settings_inner">
    ...
    <form id="cmcmg_section_settings_form" method="post" action="?page=cmcmg&tab=settings<?php echo $bid; ?>" >
        ...
        <table id="cmcmg_section_settings_table" class="cmcmg_section_settings_table form-table">
			...
			<tr>
                ...
                <td>	
					...
					<span class="cmcmg-help-tip" style="float:none;" data-tip="<?php echo __( "Url should point to admin-ajax.php e.g. www.test.com/wp-admin/admin-ajax.php" , 'cmcmg'); ?>">
						<i class="fa fa-question-circle"></i>
					</span>
					<label>Token</label>
        ...
        ?>
        <button type="submit" name="cmcmg_action" value="save_settings" class="button button-primary" ><?php echo __('Submit', 'cmcmg'); ?></button>
    </form>   
</div>